package com.cts.training.registerservice.serviceimpl;
...
//	}
	...
	public RegisterDTO insert(RegisterDTO register) {
		...
		try {
			...
			helper.setFrom("harshitahmv@gmail.com");			
			helper.setTo(register.getEmail());
			helper.setSubject("Activate");
			//sm.setText("This is testing mail");
			helper.setText("Account created click on <a href='http://localhost:4200/activate?"+register.getEmail()+"'>Click</a>",true);
	...
	public RegisterDTO update(RegisterDTO user) {
		...
		@Override
		public RegisterDTO getElementById(int id) throws NoClassDefFoundError{
		...
		@Override
		public RegisterDTO getUserBynameAndPassword(String username, String password) {
			// TODO Auto-generated method stub
			Register register = registerDAO.findByUsernameAndPassword(username, password).get();
