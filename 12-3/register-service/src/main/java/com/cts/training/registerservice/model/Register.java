package com.cts.training.registerservice.model;
...
public class Register implements Serializable {
	...
	public Register(int id, String username, String firstname, String lastname, String email, long phone,
			String password, String role, String regStatus, String active) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Register [id=" + id + ", username=" + username + ", firstname=" + firstname + ", lastname=" + lastname
				+ ", email=" + email + ", phone=" + phone + ", password=" + password + ", role=" + role + ", regStatus=" + regStatus + ", active=" + active + "]";
	}
