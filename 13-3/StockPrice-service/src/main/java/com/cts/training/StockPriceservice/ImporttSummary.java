...
public ImporttSummary() {
	
}
public ImporttSummary(int numberOfRecordsInserted, LocalDate startDate, LocalDate endDate, Set<String> companyCodes,
...
public String toString() {
	return "ImporttSummary [numberOfRecordsInserted=" + numberOfRecordsInserted + ", startDate=" + startDate
