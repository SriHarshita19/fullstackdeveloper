...
//@Query("SELECT new com.cts.training.stockpriceservice.model.StockPriceOnPeriod(companyCode,stockExchange,date,AVG(currentPrice)) "
//		+ "FROM StockPriceEntity "
//		+ "WHERE companyCode=?1 AND stockExchange=?2 AND date BETWEEN ?3 AND ?4 "
//		+ "GROUP BY date")
//
//
//public List<StockPriceOnPeriod> getStockPriceBetweenDates(String companyCode, String stockExchange, LocalDate startDate,
//		LocalDate endDate);
