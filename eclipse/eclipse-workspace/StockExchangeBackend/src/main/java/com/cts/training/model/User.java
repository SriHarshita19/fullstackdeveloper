...
public class User implements Serializable {
	...
	public User(String username, String password, String email, long phone, boolean enabled) {
	...
	public String toString() {
		return "This User [id=" + id + ", username=" + username + ", password=" + password + ", email=" + email + ", phone="
